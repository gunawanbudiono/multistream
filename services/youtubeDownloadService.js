...
function getPotArgs() {
  return [
    ...
    '--extractor-args', 'youtubepot-bgutilhttp:base_url=http://multistream-pot-provider:4416;youtube:formats=sabr;youtube:player_client=android_vr,tv_embedded,web'
  ];
}
