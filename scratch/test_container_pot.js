...
async function run() {
  ...
  const args = [
    '-c', 'import yt_dlp_plugins.extractor; import yt_dlp.extractor.youtube.pot.provider as p; print("SUBCLASSES:", [c.__name__ for c in p.PoTokenProvider.__subclasses__()])'
  ];
